...
class _DetailProductState extends State<DetailProduct> {
  String selectedColor = ''; // Lưu màu sắc đã chọn
  String selectedSize = ''; // Lưu kích thước đã chọn

  // Hàm để gửi dữ liệu màu sắc và kích thước đến API
  void updateProduct() {
    // Giả sử đây là API cập nhật
